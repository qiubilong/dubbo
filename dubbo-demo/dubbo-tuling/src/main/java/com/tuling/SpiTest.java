...
//        System.out.println(car.getCarName());
        ...
        ExtensionLoader<Person> extensionLoader = ExtensionLoader.getExtensionLoader(Person.class); /* 接口Person SPI加载器 */
        Person person = extensionLoader.getExtension("black");  /* 根据名字获取SPI实现类 */
